#!/usr/bin/env bash
# setup_labrain.sh (mac) — bootstraps labrain (private repo) via gh. Idempotent.
...
bash <(curl -fsSL "https://raw.githubusercontent.com/thinkinclabs/laboot/mac/scripts/setup_gh.sh")
